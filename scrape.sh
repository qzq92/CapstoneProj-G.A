...
# echo "Scraping traffic footages via LTA API URL until $END_TIME"
# echo " "
# python scrape_footage_camera_loc.py scrape --lta_api $LTA_API_URL --metadata_file $METADATA_FILE --agent_id $AGENT_ID --log_file $LOG_FILE --end_time $END_TIME
